...
SECRET_KEY = 'django-insecure-#7(h)18grl0gt@-$33lwu-1&2^#4g82x#%*!_i4et=2lakmsga'
...
CACHES = {
    'default': {
        ...
        'LOCATION': settings.BASE_DIR / 'cache_files',
    }
}
...
LOGGING = {
    ...
    'formatters': {
        ...
        'main_format3': {
            "format": "{asctime} - {levelname} - {message} - {pathname} - {exc_info} - 123",
            "style": "{"
        },
        '_general': {
